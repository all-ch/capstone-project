...
speech_cols = ["Presentation_Text1", "Presentation_Text2", "Presentation_Text3", "Presentation_Text4", "Presentation_Text5"]
...
if __name__ == "__main__":
    pos_embeddings, neg_embeddings = generate_anchor_embedding("data/prelim_religion_pos_anchors.csv", "data/prelim_religion_neg_anchors.csv")
    ...
    religious_score = cosine(text_embedding, pos_avg_embedding) - cosine(text_embedding, neg_avg_embedding)
